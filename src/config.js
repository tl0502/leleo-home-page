const config = {
	...
	metaData: {
		title: 'TVXL🎉',
		description: '哈基米世界！',
		keywords: 'TVXL,TVXL,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/avatar.gif", // 头像
	welcometitle: "Hi, I'm TVXL", // 标题
	...
	// 我的标签
	tags: ['会哈气', '随和亲切', '冷静沉着', '才思敏捷', '风趣幽默', '刚正不阿', '善解人意'],
	...
	//社交按钮
	socialPlatformIcons: [
		{ icon: "mdi-github", link: "https://github.com/tl0502/leleo-home-page" },
	...
	musicPlayer: {
		...
		type: 'playlist',   //歌单类型
		id: '14437136766'  //歌单id ---> music.163.com/#/playlist?id=14437136766
	},
